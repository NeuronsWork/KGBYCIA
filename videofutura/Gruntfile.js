  ...
  grunt.initConfig({
    ...
    sass: {
        dev: {
            files: {
                ...
                "assets/css/vf.css" : "assets/scss/vf.scss"
            }
        }
    },
    ...
    browserSync: {
      default_options: {
        ...
        options: {
          watchTask: true,
          proxy: "http://neuronswork.local/NeuronsWork/KGBYCIA/videofutura/"
          }
        }
      },
    ...
    cssmin: {
      ...
      target: {
        files: {//Fichero combinado   //Ficheros que vamos a combinar, 2 .css
                'assets/css/vf.min.css': ['assets/css/vf.css', 'assets/css/bootstrap.min.css']
        }
      }
    },
    ...
    uglify: {
      build: {
        src: 'assets/js/vf.js',//Ruta de fichero de entrada
        dest: 'assets/js/vf.min.js'//Ruta del fichero minificado
      }
    },
